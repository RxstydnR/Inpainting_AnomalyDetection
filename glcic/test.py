...
def test(test_loader, generator, save_path):
    ...
    for i in tqdm(range(test_loader.__len__())):
        ...
        # load data
        X_masked, X_mask, X_img = test_loader.__getitem__(i)
        X_pred = generator([X_masked,X_mask]).numpy()
...
def main():
    ...
    with tf.distribute.MirroredStrategy().scope():
            ...
            generator.load_weights(opt.model_weight)
    ...
    test(test_loader, generator, save_path=opt.SAVEPATH)
